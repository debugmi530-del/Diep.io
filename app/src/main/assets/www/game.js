    ...
    for(const k of t3keys){
      ...
      for(let vi=0;vi<3;vi++){
        ...
        _t[nk]={
          ...
          color:v.suf==='Alpha'?'#00ddff':v.suf==='Omega'?'#ff4400':'#cc00ff',
          ...
          t5GlowColor:v.suf==='Alpha'?'rgba(0,221,255,0.85)':v.suf==='Omega'?'rgba(255,68,0,0.85)':'rgba(204,0,255,0.85)'
        };
        W1[nk]=(W1[k]||k)+'·'+v.ru;
      }
    }
