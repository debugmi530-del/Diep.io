...
;(function addCustomBranches(){
  ...
  _t['Turret']={name:'Turret',requiredLevel:15,upgradesFrom:['Warlock'],color:'#22cc55',
    isAutoGunner:true,radiusMultiplier:1.05,
    description:'МЕХАНИКА: Турельщик — 3 авто-пушки, автоматически прицеливаются и стреляют в ближайшего врага.',
  ...
  _t['TurretBattery']={name:'TurretBattery',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isAutoGunner:true,radiusMultiplier:1.10,
    description:'МЕХАНИКА: Батарея турелей — 6 маленьких авто-пушек, максимальная плотность автоогня.',
  ...
  _t['TurretHeavy']={name:'TurretHeavy',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isAutoGunner:true,radiusMultiplier:1.20,bodyDamageMultiplier:1.50,
    description:'МЕХАНИКА: Тяжёлые турели — 4 мощных авто-орудия с высоким уроном, самонаводка на цель.',
  ...
  _t['TurretCannon']={name:'TurretCannon',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isAutoGunner:true,isHoming:true,radiusMultiplier:1.15,
    description:'МЕХАНИКА: Пушечные турели — 2 авто-орудия с самонаводящимися снарядами.',
  ...
  _t['TurretSwarm']={name:'TurretSwarm',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.20,
    description:'Рой турелей — 8 авто-пушек атакуют непрерывно со всех сторон.',
  ...
  _t['TurretStorm']={name:'TurretStorm',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.25,bodyDamageMultiplier:1.50,
    description:'Штормовые турели — 6 авто-орудий + мощный таран, непрерывный огонь во все стороны.',
  ...
  _t['TurretFlak']={name:'TurretFlak',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.18,
  ...
  _t['CannonTurret']={name:'CannonTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.35,bodyDamageMultiplier:2.50,
    description:'Орудийные турели — 4 тяжёлых авто-орудия + мощный броневой корпус.',
  ...
  _t['SiegeTurret']={name:'SiegeTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.40,bodyDamageMultiplier:2.00,
    description:'Осадные турели — 2 колоссальных + 2 боковых авто-орудия, крепость на колёсах.',
  ...
  _t['WarlordTurret']={name:'WarlordTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isAutoGunner:true,isInvis:true,radiusMultiplier:1.30,
    description:'МЕХАНИКА: Лорд турелей — невидим, 3 авто-орудия атакуют пока хозяин скрыт.',
  ...
  _t['MissileTurret']={name:'MissileTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isAutoGunner:true,isHoming:true,radiusMultiplier:1.25,
    description:'МЕХАНИКА: Ракетные турели — 4 авто-самонаводящихся орудия, ни одна цель не скроется.',
  ...
  _t['LongbowTurret']={name:'LongbowTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isAutoGunner:true,isRangeBoost:true,radiusMultiplier:1.20,
    description:'МЕХАНИКА: Дальнобойные турели — 3 авто-орудия с нарастающим уроном от расстояния.',
  ...
  _t['NexusTurret']={name:'NexusTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isAutoGunner:true,radiusMultiplier:1.40,bodyDamageMultiplier:1.80,
    description:'Нексус — командная башня: 4 тяжёлых + 4 лёгких авто-орудия, полная доминация зоны.',
