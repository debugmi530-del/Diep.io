...
;(function addNewBranches(){
  ...
  _t['Shotgun']={name:'Shotgun',requiredLevel:15,upgradesFrom:['Skirmisher'],color:'#22cc55',
    ...
    noBarrels:false,bodyDamageMultiplier:1.0,radiusMultiplier:1.21};
  ...
  _t['Dreadnought']={name:'Dreadnought',requiredLevel:15,upgradesFrom:['Warlord'],color:'#22cc55',
    ...
    noBarrels:false,bodyDamageMultiplier:1.3,radiusMultiplier:1.19};
  ...
  _t['Blaster']={name:'Blaster',requiredLevel:30,upgradesFrom:['Shotgun'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:0.85,radiusMultiplier:1.35};
  ...
  _t['Buster']={name:'Buster',requiredLevel:30,upgradesFrom:['Shotgun'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:1.1,radiusMultiplier:1.38};
  ...
  _t['Riot']={name:'Riot',requiredLevel:30,upgradesFrom:['Shotgun'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:0.9,radiusMultiplier:1.33};
  ...
  _t['Colossus']={name:'Colossus',requiredLevel:30,upgradesFrom:['Dreadnought'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:1.2,radiusMultiplier:1.37};
  ...
  _t['Cruiser']={name:'Cruiser',requiredLevel:30,upgradesFrom:['Dreadnought'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:1.1,radiusMultiplier:1.35};
  ...
  _t['Brawler']={name:'Brawler',requiredLevel:30,upgradesFrom:['Dreadnought'],color:'#ffdd00',
    ...
    noBarrels:false,bodyDamageMultiplier:2.5,radiusMultiplier:1.39};
...
;(function redesignClasses(){
  ...
  _t['Sniper']={name:'Sniper',requiredLevel:15,radiusMultiplier:1.19,upgradesFrom:['Assault'],color:'#22cc55',
  ...
  _t['Assassin']={name:'Assassin',requiredLevel:30,radiusMultiplier:1.34,upgradesFrom:['Sniper'],color:'#ffdd00',
    isInvis:true,
  ...
  _t['Hunter']={name:'Hunter',requiredLevel:30,radiusMultiplier:1.3,upgradesFrom:['Sniper'],color:'#ffdd00',
  ...
  _t['Stalker']={name:'Stalker',requiredLevel:30,radiusMultiplier:1.35,upgradesFrom:['Sniper'],color:'#ffdd00',
  ...
  _t['Ranger']={name:'Ranger',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['Assassin'],color:'#ff8800',
    isInvis:true,
  ...
  _t['Annihilator']={name:'Annihilator',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['Assassin'],color:'#ff8800',
  ...
  _t['Predator']={name:'Predator',requiredLevel:45,radiusMultiplier:1.4,upgradesFrom:['Assassin'],color:'#ff8800',
  ...
  _t['Streamliner']={name:'Streamliner',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['Hunter'],color:'#ff8800',
  ...
  _t['Overtrapper']={name:'Overtrapper',requiredLevel:45,radiusMultiplier:1.43,upgradesFrom:['Hunter'],color:'#ff8800',
  ...
  _t['Skimmer']={name:'Skimmer',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['Hunter'],color:'#ff8800',
  ...
  _t['Fighter']={name:'Fighter',requiredLevel:45,radiusMultiplier:1.66,upgradesFrom:['Stalker'],color:'#ff8800',
  ...
  _t['Rocketeer']={name:'Rocketeer',requiredLevel:45,radiusMultiplier:1.61,upgradesFrom:['Stalker'],color:'#ff8800',
    isHoming:true,
  ...
  _t['Landmine']={name:'Landmine',requiredLevel:45,upgradesFrom:['Stalker'],color:'#ff8800',
    isInvis:true,noBarrels:true,bodyDamageMultiplier:7,radiusMultiplier:1.63,
  ...
  _t['MachineGun']={name:'MachineGun',requiredLevel:15,radiusMultiplier:1.21,upgradesFrom:['Assault'],color:'#22cc55',
  ...
  _t['Gunner']={name:'Gunner',requiredLevel:30,radiusMultiplier:1.3,upgradesFrom:['MachineGun'],color:'#ffdd00',
  ...
  _t['Sprayer']={name:'Sprayer',requiredLevel:30,radiusMultiplier:1.3,upgradesFrom:['MachineGun'],color:'#ffdd00',
    description:'МЕХАНИКА: Один широкий ствол — хаотичный шквал с огромным конусом.',
    barrels:[el(0,50,20,0.44,1.05,0.90,0.60,0.14)]};

  // T3-C: тройной веерный залп (3 передних ствола → урон ×0.5)
  _t['TripleShot']={name:'TripleShot',requiredLevel:30,radiusMultiplier:1.34,upgradesFrom:['MachineGun'],color:'#ffdd00',
    description:'МЕХАНИКА: Три пули одновременно в широком конусе — покрывает весь фронт.',
    barrels:[el(0,46,14,1.4,0.9,1.0,0.44),el(-0.35,42,14,1.4,0.9,1.0,0.44),el(0.35,42,14,1.4,0.9,1.0,0.44)]};

  // T4 from Gunner — передний ствол + 3 реактивных задних (тяга!)
  _t['Booster']={name:'Booster',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Gunner'],color:'#ff8800',
  ...
  // T4 from Gunner — 8 стволов во все стороны (>2 фронтальных → урон ×0.5)
  _t['OctoTank']={name:'OctoTank',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Gunner'],color:'#ff8800',
    description:'МЕХАНИКА: 8 стволов по 360° — непрерывный огонь в любую сторону.',
    barrels:[0,1,2,3,4,5,6,7].map(function(i){return el(i*Math.PI/4,41,12,1.7,0.82,0.96,0.39);})};

  // T4 from Gunner — двойной пулемёт + ловушка
  _t['GunnerTrapper']={name:'GunnerTrapper',requiredLevel:45,radiusMultiplier:1.47,upgradesFrom:['Gunner'],color:'#ff8800',
  ...
  // T4 from Sprayer — пять стволов веером (5 передних → урон ×0.5)
  _t['PentaShot']={name:'PentaShot',requiredLevel:45,radiusMultiplier:1.43,upgradesFrom:['Sprayer'],color:'#ff8800',
    description:'Пять стволов одновременно — широкий веер, ни одна цель не пройдёт.',
    barrels:[-.52,-.26,0,.26,.52].map(function(i){return el(i,41,12,1.1,0.85,0.92,0.425);})};

  // T4 from Sprayer — 6 стволов спиралью (2 передних → оставляем)
  _t['Hurricane']={name:'Hurricane',requiredLevel:45,radiusMultiplier:1.47,upgradesFrom:['Sprayer'],color:'#ff8800',
  ...
  // T4 from Sprayer — четыре параллельных ствола (4 передних → урон ×0.5)
  _t['MoreGun']={name:'MoreGun',requiredLevel:45,radiusMultiplier:1.43,upgradesFrom:['Sprayer'],color:'#ff8800',
    description:'Четыре параллельных ствола — максимальная плотность огня.',
    barrels:[el(0,48,10,0.38,0.80,1.0,0.35,undefined,-21),el(0,48,10,0.38,0.80,1.0,0.35,undefined,-7),el(0,48,10,0.38,0.80,1.0,0.35,undefined,7),el(0,48,10,0.38,0.80,1.0,0.35,undefined,21)]};

  // T4 from TripleShot — 7 стволов максимальный веер (7 передних → урон ×0.5)
  _t['Spreadshot']={name:'Spreadshot',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['TripleShot'],color:'#ff8800',
    description:'7 стволов — максимально широкий веер, покрывает весь фронт.',
    barrels:[el(0,46,14,1.0,1.0,1.0,0.45),el(0.5,42,12,1.0,0.9,0.9,0.50),el(-0.5,42,12,1.0,0.9,0.9,0.50),el(0.9,38,11,1.0,0.8,0.8,0.55),el(-0.9,38,11,1.0,0.8,0.8,0.55),el(1.2,34,10,1.0,0.7,0.7,0.60),el(-1.2,34,10,1.0,0.7,0.7,0.60)]};

  // T4 from TripleShot — атака + реактивная тяга назад (1 передний → оставляем)
  _t['TriAngle']={name:'TriAngle',requiredLevel:45,radiusMultiplier:1.48,upgradesFrom:['TripleShot'],color:'#ff8800',
  ...
  // T4 from TripleShot — три диагональных ствола (3 передних → урон ×0.5)
  _t['BentHybrid']={name:'BentHybrid',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['TripleShot'],color:'#ff8800',
    description:'Три угловых ствола — диагональный огонь под 45°, охват по бокам.',
    barrels:[el(0,50,16,1.0,1.2,1.2,0.60),el(0.7,43,12,0.85,1.0,1.0,0.65),el(-0.7,43,12,0.85,1.0,1.0,0.65)]};
  ...
  _t['Scout']={name:'Scout',requiredLevel:15,upgradesFrom:['Skirmisher'],color:'#22cc55',
    ...
    barrels:[el(0,38,9,1.2,0.9,1.4,0.68)],radiusMultiplier:1.46};
  ...
  _t['ScoutGhost']={droneHits:14,name:'ScoutGhost',requiredLevel:30,upgradesFrom:['Scout'],color:'#ffdd00',
    isInvis:true,noBarrels:true,bodyDamageMultiplier:8,radiusMultiplier:1.58,
    description:'МЕХАНИКА: Полностью невидим + огромный урон корпусом — призрак-таран.',
    barrels:[]};

  // T3-C: 3 самонаводящихся дрона — охотники
  _t['Drone']={droneHits:6,name:'Drone',requiredLevel:30,radiusMultiplier:1.36,upgradesFrom:['Scout'],color:'#ffdd00',
    isDroneShooter:true,
  ...
  _t['Phantom']={name:'Phantom',requiredLevel:45,upgradesFrom:['Ninja'],color:'#ff8800',
    isInvis:true,radiusMultiplier:1.46,
  ...
  _t['Ambusher']={name:'Ambusher',requiredLevel:45,upgradesFrom:['Ninja'],color:'#ff8800',
    isInvis:true,radiusMultiplier:1.72,
  ...
  _t['Spy']={name:'Spy',requiredLevel:45,upgradesFrom:['Ninja'],color:'#ff8800',
    isInvis:true,radiusMultiplier:1.69,
  ...
  _t['Specter']={name:'Specter',requiredLevel:45,upgradesFrom:['ScoutGhost'],color:'#ff8800',
    isInvis:true,noBarrels:true,bodyDamageMultiplier:12,radiusMultiplier:1.73,
  ...
  _t['RamX']={name:'RamX',requiredLevel:45,upgradesFrom:['ScoutGhost'],color:'#ff8800',
    noBarrels:true,bodyDamageMultiplier:15,radiusMultiplier:1.73,
  ...
  _t['Mine']={name:'Mine',requiredLevel:45,upgradesFrom:['ScoutGhost'],color:'#ff8800',
    isInvis:true,bodyDamageMultiplier:4,radiusMultiplier:1.51,
  ...
  _t['Swarm']={droneHits:4,name:'Swarm',requiredLevel:45,upgradesFrom:['Drone'],color:'#ff8800',
    isDroneShooter:true,radiusMultiplier:1.51,
  ...
  _t['Guardian']={droneHits:8,name:'Guardian',requiredLevel:45,upgradesFrom:['Drone'],color:'#ff8800',
    isDroneShooter:true,radiusMultiplier:1.53,bodyDamageMultiplier:1.5,
  ...
  _t['HunterDrone']={droneHits:10,name:'HunterDrone',requiredLevel:45,upgradesFrom:['Drone'],color:'#ff8800',
    isDroneShooter:true,isInvis:true,radiusMultiplier:1.46,
  ...
  _t['Shotgun']={name:'Shotgun',requiredLevel:15,radiusMultiplier:1.21,upgradesFrom:['Skirmisher'],color:'#22cc55',
  ...
  _t['Blaster']={name:'Blaster',requiredLevel:30,radiusMultiplier:1.35,upgradesFrom:['Shotgun'],color:'#ffdd00',
  ...
  _t['Buster']={name:'Buster',requiredLevel:30,radiusMultiplier:1.38,upgradesFrom:['Shotgun'],color:'#ffdd00',
  ...
  _t['Riot']={name:'Riot',requiredLevel:30,radiusMultiplier:1.33,upgradesFrom:['Shotgun'],color:'#ffdd00',
  ...
  _t['Engineer']={droneHits:5,name:'Engineer',requiredLevel:15,upgradesFrom:['Warlord'],color:'#22cc55',
    isDroneShooter:true,radiusMultiplier:1.24,
  ...
  _t['Overseer']={droneHits:7,name:'Overseer',requiredLevel:30,upgradesFrom:['Engineer'],color:'#ffdd00',
    isDroneShooter:true,radiusMultiplier:1.39,
  ...
  _t['Commander']={droneHits:8,name:'Commander',requiredLevel:30,upgradesFrom:['Engineer'],color:'#ffdd00',
    isDroneShooter:true,radiusMultiplier:1.39,bodyDamageMultiplier:1.8,
  ...
  _t['Manager']={droneHits:12,name:'Manager',requiredLevel:45,upgradesFrom:['Overseer'],color:'#9922bb',
    isDroneShooter:true,isInvis:true,radiusMultiplier:1.52,
  ...
  _t['Necromancer']={droneHits:5,name:'Necromancer',requiredLevel:45,upgradesFrom:['Overseer'],color:'#228855',
    isDroneShooter:true,radiusMultiplier:1.52,
  ...
  _t['Marshal']={droneHits:7,name:'Marshal',requiredLevel:45,upgradesFrom:['Commander'],color:'#ff8800',
    isDroneShooter:true,radiusMultiplier:1.54,bodyDamageMultiplier:2.5,
  ...
  _t['Vanguard']={droneHits:10,name:'Vanguard',requiredLevel:45,upgradesFrom:['Commander'],color:'#ff8800',
    isDroneShooter:true,isHoming:true,radiusMultiplier:1.53,bodyDamageMultiplier:2.0,
  ...
  _t['Redoubt']={name:'Redoubt',requiredLevel:45,upgradesFrom:['Rampart'],color:'#ff8800',
    radiusMultiplier:1.72,bodyDamageMultiplier:10.0,noBarrels:true,
...
;(function addT3Branches(){
  ...
  _t['Devastator']={name:'Devastator',requiredLevel:45,upgradesFrom:['Blaster'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.8,radiusMultiplier:1.45};
  ...
  _t['Barrage']={name:'Barrage',requiredLevel:45,upgradesFrom:['Blaster'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.82,radiusMultiplier:1.48};
  ...
  _t['Canister']={name:'Canister',requiredLevel:45,upgradesFrom:['Blaster'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.9,radiusMultiplier:1.48};
  ...
  _t['Juggernaut']={name:'Juggernaut',requiredLevel:45,upgradesFrom:['Buster'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:1.2,radiusMultiplier:1.44};
  ...
  _t['Obliterator']={name:'Obliterator',requiredLevel:45,upgradesFrom:['Buster'],color:'#ff8800',
    ...
    barrels:[el(0,52,30,1.0,0.55,1.8,3.5),
             ...
             el(-Math.PI/2-0.15,34,14,1.0,0.75,1.1,1.2)],
    noBarrels:false,bodyDamageMultiplier:1.3,radiusMultiplier:1.46};
  ...
  _t['Breacher']={name:'Breacher',requiredLevel:45,upgradesFrom:['Buster'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:1.1,radiusMultiplier:1.47};
  ...
  _t['Havoc']={name:'Havoc',requiredLevel:45,upgradesFrom:['Riot'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.85,radiusMultiplier:1.42};
  ...
  _t['Tempest']={name:'Tempest',requiredLevel:45,upgradesFrom:['Riot'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.88,radiusMultiplier:1.45};
  ...
  _t['Vortex']={name:'Vortex',requiredLevel:45,upgradesFrom:['Riot'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:0.88,radiusMultiplier:1.46};
  ...
  _t['Titan']={name:'Titan',requiredLevel:45,upgradesFrom:['Colossus'],color:'#ff8800',
    ...
    barrels:[el(0,58,36,1.0,0.5,2.1,4.5),
             ...
             el(Math.PI-0.3,32,12,1.0,0.82,0.88,0.72)],
    noBarrels:false,bodyDamageMultiplier:1.4,radiusMultiplier:1.43};
  ...
  _t['Leviathan']={name:'Leviathan',requiredLevel:45,upgradesFrom:['Colossus'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:1.3,radiusMultiplier:1.42};
  ...
  _t['Bastion']={name:'Bastion',requiredLevel:45,upgradesFrom:['Colossus'],color:'#ff8800',
    ...
    barrels:[el(0,58,34,1.0,0.5,2.0,4.2),
             ...
             el(Math.PI-0.35,30,12,1.0,0.8,0.9,0.75)],
    noBarrels:false,bodyDamageMultiplier:1.25,radiusMultiplier:1.48};
  ...
  _t['Warship']={name:'Warship',requiredLevel:45,upgradesFrom:['Cruiser'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:1.2,radiusMultiplier:1.48};
  ...
  _t['Flagship']={name:'Flagship',requiredLevel:45,upgradesFrom:['Cruiser'],color:'#ff8800',
    ...
    barrels:[el(-0.1,54,28,1.0,0.54,1.7,3.2),el(0.1,54,28,1.0,0.54,1.7,3.2),
             ...
             el(-Math.PI/2-0.2,36,14,1.0,0.76,1.05,1.0)],
    noBarrels:false,bodyDamageMultiplier:1.15,radiusMultiplier:1.44};
  ...
  _t['Ironclad']={name:'Ironclad',requiredLevel:45,upgradesFrom:['Cruiser'],color:'#ff8800',
    ...
    barrels:[el(-0.08,52,26,1.0,0.56,1.55,2.8),el(0.08,52,26,1.0,0.56,1.55,2.8),
             ...
             el(-Math.PI/2-0.3,32,14,1.0,0.74,1.0,1.0)],
    noBarrels:false,bodyDamageMultiplier:1.5,radiusMultiplier:1.42};
  ...
  _t['Behemoth']={name:'Behemoth',requiredLevel:45,upgradesFrom:['Brawler'],color:'#ff8800',
    ...
    barrels:[el(0,52,28,1.0,0.58,1.5,2.8),
             ...
             el(-Math.PI/2-0.4,32,13,1.0,0.67,1.0,1.0)],
    noBarrels:false,bodyDamageMultiplier:2.8,radiusMultiplier:1.44};
  ...
  _t['Rampage']={name:'Rampage',requiredLevel:45,upgradesFrom:['Brawler'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:2.5,radiusMultiplier:1.45};
  ...
  _t['Bulwark']={name:'Bulwark',requiredLevel:45,upgradesFrom:['Brawler'],color:'#ff8800',
    ...
    noBarrels:false,bodyDamageMultiplier:3.0,radiusMultiplier:1.44};
...
;(function addCustomBranches(){
  ...
  _t['Alchemist']={name:'Alchemist',requiredLevel:5,radiusMultiplier:1.13,upgradesFrom:['Basic'],color:'#e0e0e0',
  ...
  _t['Warlock']={name:'Warlock',requiredLevel:5,radiusMultiplier:1.12,upgradesFrom:['Basic'],color:'#e0e0e0',
  ...
  // ══════════════════════════════════════════════════════════════════════════
  _t['Splitter']={name:'Splitter',requiredLevel:15,radiusMultiplier:1.2,upgradesFrom:['Alchemist'],color:'#22cc55',
    isSplitting:true,
  ...
  _t['Fragmenter']={name:'Fragmenter',requiredLevel:30,radiusMultiplier:1.38,upgradesFrom:['Splitter'],color:'#ffdd00',
    isSplitting:true,
  ...
  _t['ScatterShot']={name:'ScatterShot',requiredLevel:30,radiusMultiplier:1.38,upgradesFrom:['Splitter'],color:'#ffdd00',
    isSplitting:true,
  ...
  _t['SplitMirror']={name:'SplitMirror',requiredLevel:30,radiusMultiplier:1.36,upgradesFrom:['Splitter'],color:'#ffdd00',
    isSplitting:true,
  ...
  _t['ShardStorm']={name:'ShardStorm',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['Fragmenter'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['FragCore']={name:'FragCore',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['Fragmenter'],color:'#ff8800',
  ...
  _t['FragNova']={name:'FragNova',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Fragmenter'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['Buckshot']={name:'Buckshot',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['ScatterShot'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['ScatterBomb']={name:'ScatterBomb',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['ScatterShot'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['CloudBurst']={name:'CloudBurst',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['ScatterShot'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['DualFrag']={name:'DualFrag',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['SplitMirror'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['OmniFrag']={name:'OmniFrag',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['SplitMirror'],color:'#ff8800',
    isSplitting:true,
  ...
  _t['CrossFrag']={name:'CrossFrag',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['SplitMirror'],color:'#ff8800',
    isSplitting:true,
  ...
  // ══════════════════════════════════════════════════════════════════════════
  _t['Detonator']={name:'Detonator',requiredLevel:15,radiusMultiplier:1.24,upgradesFrom:['Alchemist'],color:'#22cc55',
    description:'МЕХАНИКА: Липкие снаряды — прилипают к врагу и взрываются через 1.5 сек. Можно наклеить несколько.',
    barrels:[Object.assign(el(-0.15,46,16,1.40,1.30,0.80,1.20),{isSticky:true}),
             Object.assign(el(0.15,46,16,1.40,1.30,0.80,1.20),{isSticky:true})]};
  W1['Detonator']='Разрывник';

  _t['Primer']={name:'Primer',requiredLevel:30,radiusMultiplier:1.31,upgradesFrom:['Detonator'],color:'#ffdd00',
    description:'Капсюльный — 4 быстрых малых заряда-липучки, стрельба короткими очередями.',
    barrels:[Object.assign(el(-0.25,40,12,1.20,1.10,0.78,1.00),{isSticky:true}),
             Object.assign(el(-0.08,44,13,1.20,1.15,0.78,1.05),{isSticky:true}),
             Object.assign(el(0.08,44,13,1.20,1.15,0.78,1.05),{isSticky:true}),
             Object.assign(el(0.25,40,12,1.20,1.10,0.78,1.00),{isSticky:true})]};
  W1['Primer']='Капсюль';

  _t['Bombard']={name:'Bombard',requiredLevel:30,radiusMultiplier:1.33,upgradesFrom:['Detonator'],color:'#ffdd00',
    description:'Бомбардир — 2 огромных заряда с чудовищным взрывом при контакте.',
    barrels:[Object.assign(el(-0.12,50,24,1.80,1.80,0.72,2.20),{isBomb:true}),
             Object.assign(el(0.12,50,24,1.80,1.80,0.72,2.20),{isBomb:true})]};
  W1['Bombard']='Бомбардир';

  _t['Minelayer']={name:'Minelayer',requiredLevel:30,radiusMultiplier:1.34,upgradesFrom:['Detonator'],color:'#ffdd00',
  ...
  _t['ChargeBurst']={name:'ChargeBurst',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['Primer'],color:'#ff8800',
    description:'Очередь зарядов — 6 быстрых зарядов-липучек в широком конусе.',
    barrels:[Object.assign(el(-0.35,36,10,1.00,1.05,0.76,0.90),{isSticky:true}),
             Object.assign(el(-0.14,40,11,1.00,1.10,0.76,0.95),{isSticky:true}),
             Object.assign(el(0,42,12,1.00,1.15,0.76,1.00),{isSticky:true}),
             Object.assign(el(0.14,40,11,1.00,1.10,0.76,0.95),{isSticky:true}),
             Object.assign(el(0.35,36,10,1.00,1.05,0.76,0.90),{isSticky:true}),
             Object.assign(el(Math.PI,32,10,1.20,1.00,0.72,0.80),{isSticky:true})]};
  W1['ChargeBurst']='Очередь зарядов';

  _t['StickyFlak']={name:'StickyFlak',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Primer'],color:'#ff8800',
    description:'Зенитные липучки — 4 вперёд + 2 боковых, перекрёстная засада из липких зарядов.',
    barrels:[Object.assign(el(-0.22,38,11,1.10,1.08,0.76,0.92),{isSticky:true}),
             Object.assign(el(-0.07,42,12,1.10,1.12,0.76,0.96),{isSticky:true}),
             Object.assign(el(0.07,42,12,1.10,1.12,0.76,0.96),{isSticky:true}),
             Object.assign(el(0.22,38,11,1.10,1.08,0.76,0.92),{isSticky:true}),
             Object.assign(el(Math.PI/2+0.10,34,11,1.30,1.05,0.72,0.88),{isSticky:true}),
             Object.assign(el(-Math.PI/2-0.10,34,11,1.30,1.05,0.72,0.88),{isSticky:true})]};
  W1['StickyFlak']='Зенитная липучка';

  _t['QuickFuse']={name:'QuickFuse',requiredLevel:45,radiusMultiplier:1.43,upgradesFrom:['Primer'],color:'#ff8800',
    description:'Быстрый взрыватель — 3 липких заряда с быстрой перезарядкой.',
    barrels:[Object.assign(el(-0.12,44,13,0.80,1.20,0.78,1.10),{isSticky:true}),
             Object.assign(el(0,48,15,0.80,1.30,0.78,1.20),{isSticky:true}),
             Object.assign(el(0.12,44,13,0.80,1.20,0.78,1.10),{isSticky:true})]};
  W1['QuickFuse']='Быстрый взрыватель';

  _t['MegaBomb']={name:'MegaBomb',requiredLevel:45,radiusMultiplier:1.47,upgradesFrom:['Bombard'],color:'#ff8800',
    description:'Мегабомба — один колоссальный заряд. Огромный радиус взрыва, максимальный урон.',
    barrels:[Object.assign(el(0,56,32,2.20,2.50,0.65,3.50),{isBomb:true})]};
  W1['MegaBomb']='Мегабомба';

  _t['DoubleBomb']={name:'DoubleBomb',requiredLevel:45,radiusMultiplier:1.41,upgradesFrom:['Bombard'],color:'#ff8800',
    description:'Двойная бомба — два огромных заряда + два боковых средних, перекрёстный взрыв.',
    barrels:[Object.assign(el(-0.10,52,26,1.80,2.00,0.68,2.50),{isBomb:true}),
             Object.assign(el(0.10,52,26,1.80,2.00,0.68,2.50),{isBomb:true}),
             Object.assign(el(Math.PI/2,36,14,1.40,1.30,0.70,1.20),{isBomb:true}),
             Object.assign(el(-Math.PI/2,36,14,1.40,1.30,0.70,1.20),{isBomb:true})]};
  W1['DoubleBomb']='Двойная бомба';

  _t['BombRain']={name:'BombRain',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['Bombard'],color:'#ff8800',
    description:'Бомбовый дождь — четыре заряда по 4 сторонам, бомбардировка 360°.',
    barrels:[Object.assign(el(0,50,22,1.60,1.80,0.68,2.20),{isBomb:true}),
             Object.assign(el(Math.PI/2,48,20,1.60,1.70,0.68,2.00),{isBomb:true}),
             Object.assign(el(Math.PI,50,22,1.60,1.80,0.68,2.20),{isBomb:true}),
             Object.assign(el(-Math.PI/2,48,20,1.60,1.70,0.68,2.00),{isBomb:true})]};
  ...
  _t['SuperMine']={name:'SuperMine',requiredLevel:45,upgradesFrom:['Minelayer'],color:'#ff8800',
    ...
    radiusMultiplier:1.44,bodyDamageMultiplier:2.00,
  ...
  _t['InvisibleMiner']={name:'InvisibleMiner',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Minelayer'],color:'#ff8800',
    isInvis:true,
  ...
  // ══════════════════════════════════════════════════════════════════════════
  _t['Longshot']={name:'Longshot',requiredLevel:15,radiusMultiplier:1.23,upgradesFrom:['Alchemist'],color:'#22cc55',
    isRangeBoost:true,
  ...
  _t['Marksman']={name:'Marksman',requiredLevel:30,radiusMultiplier:1.3,upgradesFrom:['Longshot'],color:'#ffdd00',
    isRangeBoost:true,
  ...
  _t['HeavyCannon']={name:'HeavyCannon',requiredLevel:30,radiusMultiplier:1.31,upgradesFrom:['Longshot'],color:'#ffdd00',
    isRangeBoost:true,
  ...
  _t['BurstRifle']={name:'BurstRifle',requiredLevel:30,radiusMultiplier:1.34,upgradesFrom:['Longshot'],color:'#ffdd00',
    isRangeBoost:true,
  ...
  _t['LongRangeX']={name:'LongRangeX',requiredLevel:45,radiusMultiplier:1.41,upgradesFrom:['Marksman'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['SniperX']={name:'SniperX',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Marksman'],color:'#ff8800',
  ...
  _t['TwinRifle']={name:'TwinRifle',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Marksman'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['HeavyShell']={name:'HeavyShell',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['HeavyCannon'],color:'#ff8800',
    isRangeBoost:true,isPiercing:true,
  ...
  _t['CannonBarrage']={name:'CannonBarrage',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['HeavyCannon'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['SiegeGun']={name:'SiegeGun',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['HeavyCannon'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['RapidBurst']={name:'RapidBurst',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['BurstRifle'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['TriSnipe']={name:'TriSnipe',requiredLevel:45,radiusMultiplier:1.42,upgradesFrom:['BurstRifle'],color:'#ff8800',
    isRangeBoost:true,
  ...
  _t['GaussRifle']={name:'GaussRifle',requiredLevel:45,radiusMultiplier:1.51,upgradesFrom:['BurstRifle'],color:'#ff8800',
  ...
  _t['SoulDrain']={name:'SoulDrain',requiredLevel:30,upgradesFrom:['Vampire'],color:'#ffdd00',
    isVampire:true,isDroneShooter:true,droneHits:5,radiusMultiplier:1.39,
  ...
  _t['Revenant']={name:'Revenant',requiredLevel:30,radiusMultiplier:1.38,upgradesFrom:['Vampire'],color:'#ffdd00',
  ...
  _t['Bloodlust']={name:'Bloodlust',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['BloodHunter'],color:'#ff8800',
  ...
  _t['SoulReaper']={name:'SoulReaper',requiredLevel:45,upgradesFrom:['SoulDrain'],color:'#ff8800',
    isVampire:true,isDroneShooter:true,droneHits:7,radiusMultiplier:1.5,
  ...
  _t['EclipseDrain']={name:'EclipseDrain',requiredLevel:45,upgradesFrom:['SoulDrain'],color:'#ff8800',
    isVampire:true,isDroneShooter:true,droneHits:8,isInvis:true,radiusMultiplier:1.52,
  ...
  _t['VoidDrain']={name:'VoidDrain',requiredLevel:45,upgradesFrom:['SoulDrain'],color:'#ff8800',
    isVampire:true,isDroneShooter:true,droneHits:10,radiusMultiplier:1.46,
  ...
  _t['Wraith']={name:'Wraith',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Revenant'],color:'#ff8800',
  ...
  _t['NightShade']={name:'NightShade',requiredLevel:45,radiusMultiplier:1.5,upgradesFrom:['Revenant'],color:'#ff8800',
    isVampire:true,isInvis:true,
  ...
  _t['DarkReaper']={name:'DarkReaper',requiredLevel:45,radiusMultiplier:1.52,upgradesFrom:['Revenant'],color:'#ff8800',
  ...
  // ══════════════════════════════════════════════════════════════════════════
  _t['Chainshot']={name:'Chainshot',requiredLevel:15,radiusMultiplier:1.25,upgradesFrom:['Warlock'],color:'#22cc55',
  ...
  _t['ArcaneBolt']={name:'ArcaneBolt',requiredLevel:30,radiusMultiplier:1.33,upgradesFrom:['Chainshot'],color:'#ffdd00',
    isChain:true,isHoming:true,
  ...
  _t['Thunderchain']={name:'Thunderchain',requiredLevel:30,radiusMultiplier:1.39,upgradesFrom:['Chainshot'],color:'#ffdd00',
    isChain:true,isHoming:true,
  ...
  _t['LightningRod']={name:'LightningRod',requiredLevel:30,radiusMultiplier:1.33,upgradesFrom:['Chainshot'],color:'#ffdd00',
  ...
  _t['ArcaneStorm']={name:'ArcaneStorm',requiredLevel:45,radiusMultiplier:1.49,upgradesFrom:['ArcaneBolt'],color:'#ff8800',
    isChain:true,isHoming:true,
  ...
  _t['ArcCaster']={name:'ArcCaster',requiredLevel:45,upgradesFrom:['ArcaneBolt'],color:'#ff8800',
    isChain:true,isHoming:true,isDroneShooter:true,droneHits:5,radiusMultiplier:1.52,
  ...
  _t['Thunderclap']={name:'Thunderclap',requiredLevel:45,radiusMultiplier:1.48,upgradesFrom:['Thunderchain'],color:'#ff8800',
    isChain:true,isHoming:true,
  ...
  _t['StormSurge']={name:'StormSurge',requiredLevel:45,radiusMultiplier:1.44,upgradesFrom:['Thunderchain'],color:'#ff8800',
    isChain:true,isHoming:true,
  ...
  _t['Maelstrom']={name:'Maelstrom',requiredLevel:45,radiusMultiplier:1.46,upgradesFrom:['Thunderchain'],color:'#ff8800',
    isChain:true,isHoming:true,
  ...
  _t['PlasmaChain']={name:'PlasmaChain',requiredLevel:45,radiusMultiplier:1.47,upgradesFrom:['LightningRod'],color:'#ff8800',
    isChain:true,isHoming:true,isLaser:true,
  ...
  _t['BallLightning']={name:'BallLightning',requiredLevel:45,radiusMultiplier:1.45,upgradesFrom:['LightningRod'],color:'#ff8800',
  ...
  _t['Turret']={name:'Turret',requiredLevel:15,upgradesFrom:['Warlock'],color:'#22cc55',
    isTurretDeployer:true,radiusMultiplier:1.3,
    maxTurrets:3,turretFireRate:55,turretHealth:90,turretLifetime:700,turretBulletDamage:9,turretBulletSpeed:8.5,turretBulletRadius:7,
    description:'МЕХАНИКА: Турельщик — размещает до 3 автономных турелей, которые сами стреляют во врагов и фигуры.',
    barrels:[]};
  W1['Turret']='Турельщик';

  _t['TurretBattery']={name:'TurretBattery',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isTurretDeployer:true,radiusMultiplier:1.48,
    maxTurrets:6,turretFireRate:38,turretHealth:65,turretLifetime:650,turretBulletDamage:6,turretBulletSpeed:9.5,turretBulletRadius:5,
    description:'МЕХАНИКА: Батарея турелей — размещает до 6 скорострельных турелей со всех сторон.',
    barrels:[]};
  W1['TurretBattery']='Батарея турелей';

  _t['TurretHeavy']={name:'TurretHeavy',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isTurretDeployer:true,radiusMultiplier:1.43,bodyDamageMultiplier:1.50,
    maxTurrets:3,turretFireRate:70,turretHealth:160,turretLifetime:750,turretBulletDamage:18,turretBulletSpeed:7.5,turretBulletRadius:11,
    description:'МЕХАНИКА: Тяжёлые турели — размещает 3 бронированные турели с мощными снарядами.',
    barrels:[]};
  W1['TurretHeavy']='Тяжёлые турели';

  _t['TurretCannon']={name:'TurretCannon',requiredLevel:30,upgradesFrom:['Turret'],color:'#ffdd00',
    isTurretDeployer:true,radiusMultiplier:1.46,
    maxTurrets:2,turretFireRate:85,turretHealth:120,turretLifetime:700,turretBulletDamage:22,turretBulletSpeed:6.5,turretBulletRadius:13,turretBulletHoming:true,
    description:'МЕХАНИКА: Пушечные турели — 2 турели с самонаводящимися снарядами, находят любую цель.',
    barrels:[]};
  W1['TurretCannon']='Пушечные турели';

  _t['TurretSwarm']={name:'TurretSwarm',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.58,
    maxTurrets:8,turretFireRate:28,turretHealth:55,turretLifetime:600,turretBulletDamage:5,turretBulletSpeed:10,turretBulletRadius:4,
    description:'Рой турелей — 8 крошечных турелей, осыпают ближайших врагов непрерывным огнём.',
    barrels:[]};
  W1['TurretSwarm']='Рой турелей';

  _t['TurretStorm']={name:'TurretStorm',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.55,bodyDamageMultiplier:1.50,
    maxTurrets:6,turretFireRate:32,turretHealth:80,turretLifetime:620,turretBulletDamage:8,turretBulletSpeed:9,turretBulletRadius:6,
    description:'Штормовые турели — 6 турелей + броневой корпус, огонь во все стороны одновременно.',
    barrels:[]};
  W1['TurretStorm']='Штормовые турели';

  _t['TurretFlak']={name:'TurretFlak',requiredLevel:45,upgradesFrom:['TurretBattery'],color:'#ff8800',
    isTurretDeployer:true,maxTurrets:5,turretFireRate:35,turretHealth:70,turretLifetime:640,turretBulletDamage:7,turretBulletSpeed:9,turretBulletRadius:5,radiusMultiplier:1.57,
    description:'Зенитные турели — 8 авто-орудий со всех углов, непробиваемая сеть огня.',
  ...
  _t['CannonTurret']={name:'CannonTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.6,bodyDamageMultiplier:2.50,
    maxTurrets:4,turretFireRate:80,turretHealth:200,turretLifetime:780,turretBulletDamage:28,turretBulletSpeed:7,turretBulletRadius:15,
    description:'Орудийные турели — 4 бронированные башни с огромными снарядами.',
    barrels:[]};
  W1['CannonTurret']='Орудийные турели';

  _t['SiegeTurret']={name:'SiegeTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.59,bodyDamageMultiplier:2.00,
    maxTurrets:2,turretFireRate:95,turretHealth:280,turretLifetime:800,turretBulletDamage:38,turretBulletSpeed:6,turretBulletRadius:18,
    description:'Осадные турели — 2 колоссальные башни, каждая — крепость сама по себе.',
  ...
  _t['WarlordTurret']={name:'WarlordTurret',requiredLevel:45,upgradesFrom:['TurretHeavy'],color:'#ff8800',
    isTurretDeployer:true,isInvis:true,radiusMultiplier:1.56,
    maxTurrets:3,turretFireRate:60,turretHealth:110,turretLifetime:720,turretBulletDamage:14,turretBulletSpeed:8,turretBulletRadius:9,
    description:'МЕХАНИКА: Лорд турелей — невидим, 3 автономные турели охраняют зону пока хозяин скрыт.',
  ...
  _t['MissileTurret']={name:'MissileTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.51,
    maxTurrets:4,turretFireRate:65,turretHealth:95,turretLifetime:680,turretBulletDamage:12,turretBulletSpeed:7,turretBulletRadius:9,turretBulletHoming:true,
    description:'МЕХАНИКА: Ракетные турели — 4 турели с самонаводящимися снарядами, ни одна цель не скроется.',
  ...
  _t['LongbowTurret']={name:'LongbowTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isTurretDeployer:true,isRangeBoost:true,radiusMultiplier:1.55,
    maxTurrets:3,turretFireRate:70,turretHealth:85,turretLifetime:710,turretBulletDamage:13,turretBulletSpeed:11,turretBulletRadius:8,
    description:'МЕХАНИКА: Дальнобойные турели — 3 турели с огромной дальностью обнаружения цели.',
  ...
  _t['NexusTurret']={name:'NexusTurret',requiredLevel:45,upgradesFrom:['TurretCannon'],color:'#ff8800',
    isTurretDeployer:true,radiusMultiplier:1.54,bodyDamageMultiplier:1.80,
    maxTurrets:6,turretFireRate:45,turretHealth:130,turretLifetime:760,turretBulletDamage:14,turretBulletSpeed:8.5,turretBulletRadius:9,
    description:'Нексус — командная башня: 6 автономных турелей разного типа держат всю зону, полная доминация зоны.',
...
'MegaBomb':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,40,16,1.5,1.6,0.66,1.4),{isBomb:true}),Object.assign(el(-Math.PI/3,40,16,1.5,1.6,0.66,1.4),{isBomb:true}),Object.assign(el(2*Math.PI/3,38,15,1.5,1.5,0.66,1.3),{isBomb:true}),Object.assign(el(-2*Math.PI/3,38,15,1.5,1.5,0.66,1.3),{isBomb:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'DoubleBomb':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/4,38,14,1.4,1.5,0.67,1.3),{isBomb:true}),Object.assign(el(-Math.PI/4,38,14,1.4,1.5,0.67,1.3),{isBomb:true}),Object.assign(el(3*Math.PI/4,36,13,1.4,1.4,0.67,1.2),{isBomb:true}),Object.assign(el(-3*Math.PI/4,36,13,1.4,1.4,0.67,1.2),{isBomb:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'BombRain':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/4,38,14,1.4,1.5,0.67,1.3),{isBomb:true}),Object.assign(el(-Math.PI/4,38,14,1.4,1.5,0.67,1.3),{isBomb:true}),Object.assign(el(3*Math.PI/4,36,13,1.4,1.4,0.67,1.2),{isBomb:true}),Object.assign(el(-3*Math.PI/4,36,13,1.4,1.4,0.67,1.2),{isBomb:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'MineBelt':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/6,38,14,1.4,1.5,0.67,1.3),{isTrap:true}),Object.assign(el(-Math.PI/6,38,14,1.4,1.5,0.67,1.3),{isTrap:true}),Object.assign(el(Math.PI+Math.PI/6,36,13,1.4,1.4,0.67,1.2),{isTrap:true}),Object.assign(el(Math.PI-Math.PI/6,36,13,1.4,1.4,0.67,1.2),{isTrap:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'SuperMine':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,40,15,1.5,1.6,0.66,1.4),{isTrap:true}),Object.assign(el(-Math.PI/3,40,15,1.5,1.6,0.66,1.4),{isTrap:true}),Object.assign(el(2*Math.PI/3,38,14,1.5,1.5,0.66,1.3),{isTrap:true}),Object.assign(el(-2*Math.PI/3,38,14,1.5,1.5,0.66,1.3),{isTrap:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'InvisibleMiner':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,38,14,1.4,1.5,0.67,1.3),{isTrap:true}),Object.assign(el(-Math.PI/3,38,14,1.4,1.5,0.67,1.3),{isTrap:true}),Object.assign(el(2*Math.PI/3,36,13,1.4,1.4,0.67,1.2),{isTrap:true}),Object.assign(el(-2*Math.PI/3,36,13,1.4,1.4,0.67,1.2),{isTrap:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'ChargeBurst':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,36,12,1.3,1.4,0.68,1.2),{isSticky:true}),Object.assign(el(-Math.PI/3,36,12,1.3,1.4,0.68,1.2),{isSticky:true}),Object.assign(el(2*Math.PI/3,34,11,1.3,1.3,0.68,1.1),{isSticky:true}),Object.assign(el(-2*Math.PI/3,34,11,1.3,1.3,0.68,1.1),{isSticky:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'StickyFlak':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,36,12,1.3,1.4,0.68,1.2),{isSticky:true}),Object.assign(el(-Math.PI/3,36,12,1.3,1.4,0.68,1.2),{isSticky:true}),Object.assign(el(2*Math.PI/3,34,11,1.3,1.3,0.68,1.1),{isSticky:true}),Object.assign(el(-2*Math.PI/3,34,11,1.3,1.3,0.68,1.1),{isSticky:true})],noBarrels:false,bdm:1.08,rm:0.96};},
'QuickFuse':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.20,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,38,13,1.4,1.5,0.67,1.2),{isSticky:true}),Object.assign(el(-Math.PI/3,38,13,1.4,1.5,0.67,1.2),{isSticky:true}),Object.assign(el(2*Math.PI/3,36,12,1.4,1.4,0.67,1.1),{isSticky:true}),Object.assign(el(-2*Math.PI/3,36,12,1.4,1.4,0.67,1.1),{isSticky:true})],noBarrels:false,bdm:1.08,rm:0.96};}
...
'MegaBomb':t=>({barrels:[Object.assign(el(0,58,32,2.2,2.2,0.62,3.2),{isBomb:true}),Object.assign(el(Math.PI/2,56,30,2.2,2.1,0.62,3.0),{isBomb:true}),Object.assign(el(Math.PI,58,32,2.2,2.2,0.62,3.2),{isBomb:true}),Object.assign(el(-Math.PI/2,56,30,2.2,2.1,0.62,3.0),{isBomb:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'DoubleBomb':t=>({barrels:[Object.assign(el(0,54,28,2.0,2.0,0.63,2.8),{isBomb:true}),Object.assign(el(Math.PI/2,52,26,2.0,1.9,0.63,2.6),{isBomb:true}),Object.assign(el(Math.PI,54,28,2.0,2.0,0.63,2.8),{isBomb:true}),Object.assign(el(-Math.PI/2,52,26,2.0,1.9,0.63,2.6),{isBomb:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'BombRain':t=>({barrels:[Object.assign(el(0,54,26,2.0,2.0,0.63,2.8),{isBomb:true}),Object.assign(el(Math.PI/2,52,24,2.0,1.9,0.63,2.6),{isBomb:true}),Object.assign(el(Math.PI,54,26,2.0,2.0,0.63,2.8),{isBomb:true}),Object.assign(el(-Math.PI/2,52,24,2.0,1.9,0.63,2.6),{isBomb:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'MineBelt':t=>({barrels:[Object.assign(el(0,50,26,1.8,1.8,0.64,2.4),{isTrap:true}),Object.assign(el(Math.PI/2,48,24,1.8,1.7,0.64,2.2),{isTrap:true}),Object.assign(el(Math.PI,50,26,1.8,1.8,0.64,2.4),{isTrap:true}),Object.assign(el(-Math.PI/2,48,24,1.8,1.7,0.64,2.2),{isTrap:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'SuperMine':t=>({barrels:[Object.assign(el(0,56,30,2.2,2.1,0.62,3.0),{isTrap:true}),Object.assign(el(Math.PI/2,54,28,2.2,2.0,0.62,2.8),{isTrap:true}),Object.assign(el(Math.PI,56,30,2.2,2.1,0.62,3.0),{isTrap:true}),Object.assign(el(-Math.PI/2,54,28,2.2,2.0,0.62,2.8),{isTrap:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'InvisibleMiner':t=>({barrels:[Object.assign(el(0,50,24,1.8,1.8,0.64,2.4),{isTrap:true}),Object.assign(el(Math.PI/2,48,22,1.8,1.7,0.64,2.2),{isTrap:true}),Object.assign(el(Math.PI,50,24,1.8,1.8,0.64,2.4),{isTrap:true}),Object.assign(el(-Math.PI/2,48,22,1.8,1.7,0.64,2.2),{isTrap:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'ChargeBurst':t=>({barrels:[Object.assign(el(0,46,20,1.6,1.6,0.65,2.0),{isSticky:true}),Object.assign(el(Math.PI/2,44,18,1.6,1.5,0.65,1.8),{isSticky:true}),Object.assign(el(Math.PI,46,20,1.6,1.6,0.65,2.0),{isSticky:true}),Object.assign(el(-Math.PI/2,44,18,1.6,1.5,0.65,1.8),{isSticky:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'StickyFlak':t=>({barrels:[Object.assign(el(0,46,20,1.6,1.6,0.65,2.0),{isSticky:true}),Object.assign(el(Math.PI/2,44,18,1.6,1.5,0.65,1.8),{isSticky:true}),Object.assign(el(Math.PI,46,20,1.6,1.6,0.65,2.0),{isSticky:true}),Object.assign(el(-Math.PI/2,44,18,1.6,1.5,0.65,1.8),{isSticky:true})],noBarrels:false,bdm:1.28,rm:1.32}),
'QuickFuse':t=>({barrels:[Object.assign(el(0,50,22,1.8,1.8,0.64,2.2),{isSticky:true}),Object.assign(el(Math.PI/2,48,20,1.8,1.7,0.64,2.0),{isSticky:true}),Object.assign(el(Math.PI,50,22,1.8,1.8,0.64,2.2),{isSticky:true}),Object.assign(el(-Math.PI/2,48,20,1.8,1.7,0.64,2.0),{isSticky:true})],noBarrels:false,bdm:1.28,rm:1.32})
...
'MegaBomb':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,40,15,1.3,1.6,0.70,1.4),{isBomb:true}),Object.assign(el(-Math.PI/3,40,15,1.3,1.6,0.70,1.4),{isBomb:true}),Object.assign(el(2*Math.PI/3,38,14,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(-2*Math.PI/3,38,14,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(Math.PI,36,13,1.2,1.4,0.70,1.2),{isBomb:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'DoubleBomb':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(-Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isBomb:true}),Object.assign(el(-2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isBomb:true}),Object.assign(el(Math.PI,34,11,1.2,1.3,0.70,1.1),{isBomb:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'BombRain':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/4,38,13,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(-Math.PI/4,38,13,1.3,1.5,0.70,1.3),{isBomb:true}),Object.assign(el(3*Math.PI/4,36,12,1.3,1.4,0.70,1.2),{isBomb:true}),Object.assign(el(-3*Math.PI/4,36,12,1.3,1.4,0.70,1.2),{isBomb:true}),Object.assign(el(Math.PI,34,11,1.2,1.3,0.70,1.1),{isBomb:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'MineBelt':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/6,38,13,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(-Math.PI/6,38,13,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(Math.PI+Math.PI/6,36,12,1.3,1.4,0.70,1.2),{isTrap:true}),Object.assign(el(Math.PI-Math.PI/6,36,12,1.3,1.4,0.70,1.2),{isTrap:true}),Object.assign(el(Math.PI/2,34,11,1.2,1.3,0.70,1.1),{isTrap:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'SuperMine':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,40,15,1.3,1.6,0.70,1.4),{isTrap:true}),Object.assign(el(-Math.PI/3,40,15,1.3,1.6,0.70,1.4),{isTrap:true}),Object.assign(el(2*Math.PI/3,38,14,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(-2*Math.PI/3,38,14,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(Math.PI,36,13,1.2,1.4,0.70,1.2),{isTrap:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'InvisibleMiner':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(-Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isTrap:true}),Object.assign(el(2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isTrap:true}),Object.assign(el(-2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isTrap:true}),Object.assign(el(Math.PI,34,11,1.2,1.3,0.70,1.1),{isTrap:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'ChargeBurst':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,36,12,1.2,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(-Math.PI/3,36,12,1.2,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(2*Math.PI/3,34,11,1.2,1.3,0.70,1.1),{isSticky:true}),Object.assign(el(-2*Math.PI/3,34,11,1.2,1.3,0.70,1.1),{isSticky:true}),Object.assign(el(Math.PI,32,10,1.1,1.2,0.70,1.0),{isSticky:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'StickyFlak':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,36,12,1.2,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(-Math.PI/3,36,12,1.2,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(2*Math.PI/3,34,11,1.2,1.3,0.70,1.1),{isSticky:true}),Object.assign(el(-2*Math.PI/3,34,11,1.2,1.3,0.70,1.1),{isSticky:true}),Object.assign(el(Math.PI,32,10,1.1,1.2,0.70,1.0),{isSticky:true})],noBarrels:false,bdm:1.15,rm:1.05};},
'QuickFuse':t=>{const e=(t.barrels||[]).map(b=>Object.assign({...b},{bulletDamageMultiplier:(b.bulletDamageMultiplier||1)*1.28,length:Math.round((b.length||40)*1.1),isBomb:true}));return{barrels:[...e,Object.assign(el(Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isSticky:true}),Object.assign(el(-Math.PI/3,38,13,1.3,1.5,0.70,1.3),{isSticky:true}),Object.assign(el(2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(-2*Math.PI/3,36,12,1.3,1.4,0.70,1.2),{isSticky:true}),Object.assign(el(Math.PI,34,11,1.2,1.3,0.70,1.1),{isSticky:true})],noBarrels:false,bdm:1.15,rm:1.05};}
  ...
  ;(function patchTier3(){
    ...
    if(_t['OctoTank']){
      _t['OctoTank'].barrels=[
        el(0,          44,14,0.72,1.12,0.92,0.46,undefined,-6), el(0,          40,12,0.78,1.02,0.86,0.41,undefined,6),
        el(Math.PI/2,  44,14,0.72,1.12,0.92,0.46,undefined,-6), el(Math.PI/2,  40,12,0.78,1.02,0.86,0.41,undefined,6),
        el(Math.PI,    44,14,0.72,1.12,0.92,0.46,undefined,-6), el(Math.PI,    40,12,0.78,1.02,0.86,0.41,undefined,6),
        el(-Math.PI/2, 44,14,0.72,1.12,0.92,0.46,undefined,-6), el(-Math.PI/2, 40,12,0.78,1.02,0.86,0.41,undefined,6),
      ];
    ...
    if(_t['Spreadshot']){
      _t['Spreadshot'].barrels=[
        el(-0.22, 44,11,0.68,1.12,0.88,0.46),
        el(-0.08, 46,12,0.65,1.12,0.90,0.51),
        el(0,     48,13,0.62,1.12,0.92,0.56),
        el( 0.08, 46,12,0.65,1.12,0.90,0.51),
        el( 0.22, 44,11,0.68,1.12,0.88,0.46),
...
// ── NamesGuide init: load persisted custom names from localStorage ──────
;(function(){
  try{
    var _sn=localStorage.getItem("diep_bot_names");
    if(_sn){var _arr=JSON.parse(_sn);if(Array.isArray(_arr)&&_arr.length>0)window._GAME_BOT_NAMES=_arr;}
  }catch(e){}
})();

var _DEFAULT_BOT_NAMES=["Shadow","Viper","Storm","Blaze","Frost","Phantom","Nova","Raven","Wolf","Titan","Ghost","Cobra","Reaper","Blade","Surge","Thunder","Phoenix","Ninja","Omega","Zephyr","Orion","Knight","Ace","Fury","Chaos","Призрак","Тень","Буря","Огонь","Мороз","Вихрь","Гром","Ворон","Волк","Сокол","Дракон","Стрела","Клинок","Меч","Охотник","Воин","Рыцарь","Страж","Быстрый","Сильный","Мститель","Победа","Честь","Илья","Руслан"];

function NamesGuide({onClose}){
  var _cur=(window._GAME_BOT_NAMES&&window._GAME_BOT_NAMES.length>0)?window._GAME_BOT_NAMES:_DEFAULT_BOT_NAMES;
  var [_text,_setText]=cl.useState(_cur.join("\n"));
  var [_ok,_setOk]=cl.useState(false);
  var _cnt=_text.split("\n").filter(function(n){return n.trim().length>0;}).length;
  function _save(){
    var names=_text.split("\n").map(function(n){return n.trim();}).filter(function(n){return n.length>0;});
    if(names.length===0)return;
    window._GAME_BOT_NAMES=names;
    localStorage.setItem("diep_bot_names",JSON.stringify(names));
    _setOk(true);setTimeout(function(){_setOk(false);},1600);
  }
  function _reset(){
    window._GAME_BOT_NAMES=[].concat(_DEFAULT_BOT_NAMES);
    try{localStorage.removeItem("diep_bot_names");}catch(e){}
    try{localStorage.removeItem("diep_bot_names_custom");}catch(e){}
    try{localStorage.removeItem("diep_bot_names_backup");}catch(e){}
    _setText(_DEFAULT_BOT_NAMES.join("\n"));
  }
  return D.jsx("div",{style:{position:"fixed",inset:0,zIndex:9999,
    ...
    children:D.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%"},
      children:[
        D.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",
          padding:"16px 20px",borderBottom:"1.5px solid rgba(68,136,255,0.25)",
          background:"rgba(13,21,50,0.98)",flexShrink:0},
          children:[
            D.jsxs("div",{children:[
              D.jsx("div",{style:{color:"#00b2e1",fontSize:19,fontWeight:"bold",letterSpacing:1,textShadow:"0 0 12px #ff449966"},children:"✏️ Имена ботов"}),
              D.jsx("div",{style:{color:"rgba(150,200,255,0.45)",fontSize:11,marginTop:3},children:"Одно имя на строку · "+_cnt+" имён"})
            ]}),
            D.jsx("button",{onClick:onClose,style:{background:"rgba(68,136,255,0.15)",
              border:"1.5px solid rgba(68,136,255,0.4)",borderRadius:9,color:"#88ccff",
              fontSize:13,fontWeight:"bold",padding:"8px 20px",cursor:"pointer",
              touchAction:"manipulation"},children:"✕ Закрыть"})
          ]
        }),
        D.jsx("div",{style:{flex:1,padding:"14px 16px",overflow:"hidden",display:"flex",flexDirection:"column",gap:8},
          children:[
            D.jsx("div",{style:{color:"rgba(150,200,255,0.5)",fontSize:11,fontFamily:"Arial",paddingLeft:4},children:"Введите имена — каждое с новой строки:"}),
            D.jsx("textarea",{value:_text,onChange:function(e){_setText(e.target.value);},
              spellCheck:false,
              style:{flex:1,width:"100%",
                background:"rgba(13,21,50,0.95)",
                border:"1.5px solid rgba(68,136,255,0.3)",
                borderRadius:12,color:"#d0e8ff",
        ...
        D.jsxs("div",{style:{display:"flex",gap:10,padding:"14px 16px",
          borderTop:"1.5px solid rgba(68,136,255,0.18)",
          background:"rgba(13,21,50,0.98)",flexShrink:0},
          children:[
            D.jsx("button",{onClick:_reset,
              style:{padding:"13px 20px",fontSize:14,fontWeight:"bold",
                borderRadius:10,border:"2px solid rgba(255,68,153,0.4)",
                background:"rgba(5,30,60,0.8)",color:"#88ccff",
                cursor:"pointer",touchAction:"manipulation",whiteSpace:"nowrap",
                transition:"opacity 0.15s"},
              children:"↺ По умолчанию"}),
            D.jsx("button",{onClick:_save,
              style:{flex:1,padding:"13px",fontSize:16,fontWeight:"bold",
                borderRadius:10,border:"none",
                background:_ok?"linear-gradient(90deg,#22aa44,#44cc66)":"linear-gradient(90deg,#0077cc,#00aaff)",
                color:"#fff",cursor:"pointer",transition:"background 0.3s",
                touchAction:"manipulation"},
              children:_ok?"✓ Сохранено!":"💾 Сохранить"})
          ]
        })
      ]
    })
...
;(function patchSplittingAndRangeBoost(){
  ...
  function _spawnFragments(rec){
    var n   = 4;
    var baseSpd = Math.sqrt(rec.vx*rec.vx + rec.vy*rec.vy);
    // Completely random scatter — different every time
    var usedAngles = [];
    for(var i=0;i<n;i++){
      // Pick angle far enough from already-used ones (min 30° apart)
      var a, attempts=0;
      do {
        a = Math.random() * Math.PI * 2;
        var ok = true;
        for(var j=0;j<usedAngles.length;j++){
          var diff = Math.abs(a - usedAngles[j]);
          if(diff > Math.PI) diff = Math.PI*2 - diff;
          if(diff < 0.52) { ok=false; break; } // ~30 degrees min separation
        }
        attempts++;
      } while(!ok && attempts < 20);
      usedAngles.push(a);
      // Random speed: 0.9× to 1.4× of original bullet speed
      var spd = baseSpd * (0.9 + Math.random() * 0.5);
      window._splitQueue.push({
        id          : _fragId(),
        pos         : {x: rec.px, y: rec.py},
        vel         : {x: Math.cos(a)*spd, y: Math.sin(a)*spd},
        radius      : rec.r  * (0.45 + Math.random()*0.15),
        damage      : rec.dmg* 0.38,
        penetration : 1,
        ownerId     : '_split',
        isNpc       : rec.isNpc,
        ...
        lifetime    : Math.floor(28 + Math.random()*12),
        maxLifetime : 40,
        isHoming    : false,
        isDrone     : false,
        isTrap      : false,
  ...
  function _tickSplits(){
    ...
    for(var ki=0;ki<keys.length;ki++){
      var id  = keys[ki];
      var rec = amap[id];
      if(!rec) continue; // cleaned up by engine Patch-C (bullet died)
      rec.px += rec.vx;
      rec.py += rec.vy;
      rec.age++;
      if(rec.age === rec.splitAt){
        // Only spawn fragments if bullet is still alive in engine
        // (Patch-C removes dead IDs every tick, so presence here = alive)
        _spawnFragments(rec);
        delete amap[id];
      } else if(rec.age > rec.life + 2){
        // Expired cleanup — should already be gone via Patch-C
        delete amap[id];
      }
    }
...
;(function setupTankBuilder(){
  ...
  function _renderEdit(p){
    ...
    var rotBtn=document.createElement('button');rotBtn.textContent='↻ Повернуть все';rotBtn.style.cssText='padding:5px 9px;border-radius:7px;border:1px solid rgba(255,180,50,0.35);background:rgba(40,30,0,0.4);color:#ffcc66;font-size:11px;cursor:pointer;';rotBtn.onclick=function(){var ov=document.createElement('div');ov.style.cssText='position:fixed;inset:0;z-index:20000;background:rgba(0,0,0,0.82);display:flex;align-items:center;justify-content:center;';ov.onclick=function(e){if(e.target===ov)document.body.removeChild(ov);};var box=document.createElement('div');box.style.cssText='background:#0d1525;border:1.5px solid rgba(255,180,50,0.5);border-radius:14px;padding:20px;width:280px;';box.innerHTML='<div style="color:#ffcc66;font-weight:bold;font-size:14px;margin-bottom:10px;">↻ Угол поворота</div><div style="color:rgba(255,255,255,0.45);font-size:11px;margin-bottom:8px;">0.52 = 30° · 0.79 = 45° · 1.57 = 90° · 3.14 = 180°</div>';var ri=document.createElement('input');ri.type='number';ri.step='0.01';ri.value='0.52';ri.style.cssText='width:100%;padding:9px 10px;border-radius:8px;border:1px solid rgba(255,180,50,0.4);background:rgba(255,255,255,0.07);color:#fff;font-size:15px;box-sizing:border-box;margin-bottom:10px;';box.appendChild(ri);var rb=document.createElement('button');rb.textContent='✅ Применить';rb.style.cssText='width:100%;padding:10px;border-radius:8px;border:none;background:linear-gradient(90deg,#a06000,#cc8800);color:#fff;font-size:13px;cursor:pointer;';rb.onclick=function(){var a=parseFloat(ri.value);if(isNaN(a)){document.body.removeChild(ov);return;}document.body.removeChild(ov);_state.barrels=_state.barrels.map(function(b){return Object.assign({},b,{ao:(b.ao||0)+a});});_render();};box.appendChild(rb);var cb=document.createElement('button');cb.textContent='Отмена';cb.style.cssText='width:100%;margin-top:6px;padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,0.15);background:rgba(255,255,255,0.04);color:rgba(255,255,255,0.45);font-size:12px;cursor:pointer;';cb.onclick=function(){document.body.removeChild(ov);};box.appendChild(cb);ov.appendChild(box);document.body.appendChild(ov);ri.focus();};toolsRow.appendChild(rotBtn);
