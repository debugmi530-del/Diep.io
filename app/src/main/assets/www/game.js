...
function _AdminPanelUI({gs,fu,onClose}){
  ...
  return D.jsxs('div',{style:{position:'absolute',top:0,right:0,bottom:0,width:260,background:'rgba(5,10,25,0.97)',borderLeft:'2px solid rgba(80,180,80,0.5)',zIndex:800,display:'flex',flexDirection:'column',fontFamily:'Arial',overflowY:'auto'},children:[
    ...
    tab==='npc'&&D.jsxs('div',{style:{padding:'8px'},children:[
      ...
      D.jsx('input',{type:'range',min:1,max:60,value:npcLevel,onChange:function(e){setNpcLevel(parseInt(e.target.value));},style:{width:'100%',accentColor:'#44ff88',marginBottom:8}}),
