...
function NamesGuide({onClose}){
  ...
  function _reset(){
    ...
    localStorage.removeItem("diep_bot_names");
    ...
    children:D.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%"},
      children:[
        D.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",
          padding:"14px 18px",borderBottom:"1.5px solid rgba(255,255,255,0.10)",
          background:"rgba(6,8,22,0.98)",flexShrink:0},
          children:[
            D.jsxs("div",{children:[
              D.jsx("div",{style:{color:"#88ddff",fontSize:18,fontWeight:"bold",letterSpacing:1},children:"📝 Имена ботов"}),
              D.jsx("div",{style:{color:"rgba(255,255,255,0.35)",fontSize:11,marginTop:2},children:"Одно имя на строку — "+_cnt+" имён"})
            ]}),
            D.jsx("button",{onClick:onClose,style:{background:"rgba(200,40,40,0.22)",
              border:"1.5px solid rgba(220,60,60,0.5)",borderRadius:9,color:"#ff8888",
              fontSize:13,fontWeight:"bold",padding:"7px 18px",cursor:"pointer",
              touchAction:"manipulation"},children:"✕ Закрыть"})
          ]
        }),
        D.jsx("div",{style:{flex:1,padding:"12px 14px",overflow:"hidden",display:"flex",flexDirection:"column"},
          children:D.jsx("textarea",{value:_text,onChange:function(e){_setText(e.target.value);},
            spellCheck:false,
            style:{flex:1,width:"100%",
              background:"rgba(10,14,38,0.97)",
              border:"1.5px solid rgba(68,136,255,0.35)",
              borderRadius:12,color:"#e0eeff",
              fontFamily:"monospace",fontSize:16,
              padding:"12px 14px",resize:"none",
              outline:"none",boxSizing:"border-box",lineHeight:1.8}})
        }),
        D.jsxs("div",{style:{display:"flex",gap:10,padding:"12px 14px",
          borderTop:"1.5px solid rgba(255,255,255,0.08)",
          background:"rgba(6,8,22,0.98)",flexShrink:0},
          children:[
            D.jsx("button",{onClick:_reset,
              style:{padding:"12px 20px",fontSize:14,fontWeight:"bold",
                borderRadius:10,border:"2px solid rgba(255,200,50,0.45)",
                background:"rgba(80,60,10,0.6)",color:"#f0c040",
                cursor:"pointer",touchAction:"manipulation",whiteSpace:"nowrap"},
              children:"↺ По умолчанию"}),
            D.jsx("button",{onClick:_save,
              style:{flex:1,padding:"12px",fontSize:16,fontWeight:"bold",
                borderRadius:10,border:"none",
                background:_ok?"linear-gradient(90deg,#22aa44,#44cc66)":"linear-gradient(90deg,#0098c8,#44b4e0)",
