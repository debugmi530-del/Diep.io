...
function NamesGuide({onClose}){
  ...
  return D.jsx("div",{style:{position:"fixed",inset:0,zIndex:9999,
    background:"linear-gradient(135deg,#1a0814 0%,#280a20 55%,#1a0818 100%)",
    ...
    children:D.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%"},
      children:[
        D.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",
          padding:"16px 20px",borderBottom:"1.5px solid rgba(255,68,153,0.25)",
          background:"rgba(30,5,20,0.98)",flexShrink:0},
          children:[
            D.jsxs("div",{children:[
              D.jsx("div",{style:{color:"#ff66aa",fontSize:19,fontWeight:"bold",letterSpacing:1,textShadow:"0 0 12px #ff449966"},children:"✏️ Имена ботов"}),
              D.jsx("div",{style:{color:"rgba(255,180,220,0.45)",fontSize:11,marginTop:3},children:"Одно имя на строку · "+_cnt+" имён"})
            ]}),
            D.jsx("button",{onClick:onClose,style:{background:"rgba(255,68,153,0.15)",
              border:"1.5px solid rgba(255,68,153,0.4)",borderRadius:9,color:"#ff99cc",
        ...
        D.jsx("div",{style:{flex:1,padding:"14px 16px",overflow:"hidden",display:"flex",flexDirection:"column",gap:8},
          children:[
            D.jsx("div",{style:{color:"rgba(255,150,200,0.5)",fontSize:11,fontFamily:"Arial",paddingLeft:4},children:"Введите имена — каждое с новой строки:"}),
            D.jsx("textarea",{value:_text,onChange:function(e){_setText(e.target.value);},
              spellCheck:false,
              style:{flex:1,width:"100%",
                background:"rgba(40,5,25,0.95)",
                border:"1.5px solid rgba(255,68,153,0.3)",
                borderRadius:12,color:"#ffd0e8",
        ...
        D.jsxs("div",{style:{display:"flex",gap:10,padding:"14px 16px",
          borderTop:"1.5px solid rgba(255,68,153,0.18)",
          background:"rgba(30,5,20,0.98)",flexShrink:0},
          children:[
            D.jsx("button",{onClick:_reset,
              style:{padding:"13px 20px",fontSize:14,fontWeight:"bold",
                ...
                background:"rgba(60,5,35,0.8)",color:"#ff99cc",
            ...
            D.jsx("button",{onClick:_save,
              style:{flex:1,padding:"13px",fontSize:16,fontWeight:"bold",
                ...
                background:_ok?"linear-gradient(90deg,#22aa44,#44cc66)":"linear-gradient(90deg,#ff1177,#ff55aa)",
...
function Dy({onStart:i,uiScale:_uiScV,setUiScale:_sUiScV}){if(window._gamePhase==="playing")return null;const[h,o]=cl.useState("Player"),[s,T]=cl.useState(!1),[Jt,ft]=cl.useState(!1),[_mo,_sm]=cl.useState("classic"),[_msOpen,_setMsOpen]=cl.useState(!1),[_stOpen,_setStOpen]=cl.useState(false),[_stTab,_setStTab]=cl.useState("ui"),[_shOpen,_setShOpen]=cl.useState(false),[_nmOpen,_setNmOpen]=cl.useState(false);const _mds=[{id:"classic",icon:"🎯",nm:"Классика",ds:"Стандарт. Качай танк и уничтожай врагов."},{id:"survival",icon:"💥",nm:"Выживание",ds:"Зона сужается. Выживи последним!"},{id:"domination",icon:"🏴",nm:"Доминирование",ds:"Захвати 3 точки. Первый до 300."},{id:"zombie",icon:"🧟",nm:"Зомби",ds:"Выживи 3 минуты. Не заразись!"},{id:"horde",icon:"🌊",nm:"Волны",ds:"Бесконечные волны врагов!"},{id:"sniper",icon:"🔭",nm:"Снайперы",ds:"Только снайперские классы."}];const _mlv=parseInt(localStorage.getItem("diep_maxLevel")||"1"),_req={classic:0,sniper:15,survival:25,horde:35,domination:45,zombie:60};return D.jsx("div",{style:{position:"fixed",inset:0,background:"linear-gradient(135deg, #1a0814 0%, #280a20 55%, #1a0818 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"Arial, sans-serif",zIndex:300,padding:20,overflowY:"auto"},children:D.jsxs("div",{style:{textAlign:"center",width:"100%",padding:"0 24px",boxSizing:"border-box"},children:[D.jsx("div",{style:{fontSize:52,fontWeight:900,color:"#ff4499",textShadow:"0 0 30px #ff449988, 0 4px 8px #000",marginBottom:4,letterSpacing:2},children:"DIEP"}),D.jsx("div",{style:{fontSize:16,color:"rgba(255,255,255,0.5)",marginBottom:20,letterSpacing:4},children:"CLONE"}),D.jsx("div",{style:{marginBottom:14},children:D.jsx("input",{value:h,onChange:v=>o(v.target.value.slice(0,16)),onKeyDown:v=>{v.key==="Enter"&&h.trim()&&i(h.trim(),_mo==="classic"&&Jt,_mo)},placeholder:"Ваш ник...",maxLength:16,style:{width:"100%",padding:"12px 18px",fontSize:16,borderRadius:10,border:"2px solid rgba(255,68,153,0.5)",background:"rgba(255,255,255,0.07)",color:"#fff",outline:"none",boxSizing:"border-box",textAlign:"center",letterSpacing:1}})}),_msOpen&&D.jsx("div",{style:{position:"fixed",inset:0,zIndex:9999,background:"rgba(0,0,0,0.78)",display:"flex",alignItems:"center",justifyContent:"center",padding:20},onClick:()=>_setMsOpen(!1),children:D.jsxs("div",{style:{background:"#1a0514",border:"1.5px solid rgba(255,68,153,0.4)",borderRadius:16,padding:20,maxWidth:480,width:"100%",maxHeight:"85vh",overflowY:"auto"},onClick:e=>e.stopPropagation(),children:[D.jsx("div",{style:{color:"#c8a018",fontSize:15,fontWeight:"bold",textAlign:"center",marginBottom:14},children:"Выбери режим:"}),D.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,marginBottom:12},children:_mds.map(m=>D.jsxs("button",{onClick:()=>{const _lok=_mlv<(_req[m.id]||0);if(!_lok){_sm(m.id);_setMsOpen(!1);}},style:{padding:"10px 6px",borderRadius:12,border:!(_mlv<(_req[m.id]||0))&&_mo===m.id?"2px solid #ff4499":"2px solid rgba(255,255,255,0.12)",background:!(_mlv<(_req[m.id]||0))&&_mo===m.id?"rgba(160,0,80,0.55)":"rgba(255,255,255,0.04)",color:!(_mlv<(_req[m.id]||0))&&_mo===m.id?"#fff":"rgba(255,255,255,0.55)",cursor:_mlv<(_req[m.id]||0)?"not-allowed":"pointer",textAlign:"center",transition:"all 0.15s",touchAction:"manipulation",position:"relative",overflow:"hidden"},children:[D.jsxs("div",{style:{filter:_mlv<(_req[m.id]||0)?"grayscale(1) blur(1.5px) brightness(0.4)":"none",transition:"filter 0.2s"},children:[D.jsx("div",{style:{fontSize:20,marginBottom:2},children:m.icon}),D.jsx("div",{style:{fontSize:11,fontWeight:"bold",marginBottom:2},children:m.nm}),D.jsx("div",{style:{fontSize:9,color:_mo===m.id?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.35)",lineHeight:1.3},children:m.ds})]}),_mlv<(_req[m.id]||0)&&D.jsx("div",{style:{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"rgba(0,0,0,0.55)",borderRadius:10},children:D.jsxs("div",{style:{textAlign:"center"},children:[D.jsx("div",{style:{fontSize:16},children:m.icon}),D.jsx("div",{style:{fontSize:9,color:"rgba(255,220,80,0.95)",fontWeight:"bold",marginTop:2},children:"Уровень "+(_req[m.id]||0)})]})})]},m.id))}),D.jsx("button",{onClick:()=>_setMsOpen(!1),style:{marginTop:8,width:"100%",padding:"9px",background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.15)",borderRadius:10,color:"rgba(255,255,255,0.55)",cursor:"pointer",fontSize:13},children:"Закрыть"})]})}),D.jsx("button",{onClick:()=>_setMsOpen(!0),style:{width:"100%",padding:"11px 14px",borderRadius:12,border:"2px solid rgba(255,68,153,0.35)",background:"rgba(80,0,40,0.4)",color:"#fff",cursor:"pointer",textAlign:"left",marginBottom:16,display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:13,touchAction:"manipulation"},children:[D.jsxs("span",{style:{display:"flex",alignItems:"center",gap:8},children:[D.jsx("span",{style:{fontSize:18},children:(_mds.find(m=>m.id===_mo)||_mds[0]).icon}),D.jsxs("span",{children:[D.jsx("span",{style:{color:"rgba(255,255,255,0.45)",fontSize:11},children:"Режим: "}),D.jsx("span",{style:{fontWeight:"bold"},children:(_mds.find(m=>m.id===_mo)||_mds[0]).nm})]})]}),D.jsx("span",{style:{color:"rgba(255,255,255,0.45)",fontSize:12},children:"▼ выбрать"})]}),D.jsxs("div",{style:{display:"flex",gap:12,marginBottom:20},children:[_mo==="classic"?D.jsx("button",{onClick:()=>ft(v=>!v),style:{padding:"13px 18px",fontSize:14,fontWeight:"bold",borderRadius:12,border:Jt?"2px solid #4488ff":"2px solid rgba(255,255,255,0.2)",background:Jt?"rgba(30,60,140,0.8)":"rgba(30,30,50,0.6)",color:Jt?"#88ccff":"rgba(255,255,255,0.6)",cursor:"pointer",whiteSpace:"nowrap",touchAction:"manipulation"},children:Jt?"⚔ Команды ВКЛ":"⚔ Команды ВЫКЛ"}):null,D.jsx("button",{onClick:()=>h.trim()&&i(h.trim(),_mo==="classic"&&Jt,_mo),disabled:!h.trim(),style:{flex:1,padding:"13px",fontSize:18,fontWeight:"bold",borderRadius:12,border:"none",background:h.trim()?"linear-gradient(90deg,#ff1177,#ff55aa)":"rgba(100,100,100,0.4)",color:h.trim()?"#fff":"#888",cursor:h.trim()?"pointer":"default",boxShadow:h.trim()?"0 4px 16px #ff449955":"none",transition:"all 0.2s"},children:"Играть"}),D.jsx("button",{onClick:()=>T(v=>!v),style:{padding:"13px 18px",fontSize:15,fontWeight:"bold",borderRadius:12,border:"2px solid rgba(255,200,50,0.4)",background:s?"rgba(255,200,50,0.15)":"rgba(255,255,255,0.05)",color:"#c8a018",cursor:"pointer",transition:"all 0.2s",whiteSpace:"nowrap"},children:"🌿 Дерево"}),D.jsx("button",{onClick:()=>_setNmOpen(true),style:{padding:"13px 18px",fontSize:15,fontWeight:"bold",borderRadius:12,border:"2px solid rgba(255,100,170,0.35)",background:"rgba(60,0,30,0.5)",color:"#ff99cc",cursor:"pointer",transition:"all 0.2s",whiteSpace:"nowrap",touchAction:"manipulation"},children:"📝 Имена"}),D.jsx("button",{onClick:()=>_setShOpen(true),style:{padding:"13px 18px",fontSize:15,fontWeight:"bold",borderRadius:12,border:"2px solid rgba(255,100,170,0.4)",background:"rgba(60,0,30,0.4)",color:"#ff99cc",cursor:"pointer",transition:"all 0.2s",whiteSpace:"nowrap",touchAction:"manipulation"},children:"📐 Фигуры"})]}),s&&D.jsx(zy,{onClose:()=>T(false)}),_nmOpen&&D.jsx(NamesGuide,{onClose:()=>_setNmOpen(false)}),_shOpen&&D.jsx(ShapesGuide,{onClose:()=>_setShOpen(false)}),!s&&D.jsxs(D.Fragment,{children:[D.jsxs("div",{style:{color:"rgba(255,255,255,0.3)",fontSize:12,lineHeight:1.8},children:[D.jsx("div",{style:{fontWeight:"bold",color:"rgba(255,255,255,0.45)",marginBottom:4},children:"Управление:"}),D.jsx("div",{children:"WASD / Стрелки — движение  |  Мышь — прицел  |  ЛКМ / Пробел — стрельба"}),D.jsx("div",{style:{marginTop:2},children:"📱 Два джойстика на мобильном — касайтесь в любом месте"})]}),D.jsx("div",{style:{marginTop:14,display:"flex",gap:10,justifyContent:"center",flexWrap:"wrap"},children:["Уничтожай фигуры","Прокачивай танк","Бейся с NPC",D.jsx("div",{style:{display:"flex",justifyContent:"flex-end",marginBottom:8},children:D.jsx("button",{onClick:()=>_setStOpen(true),style:{padding:"8px 16px",borderRadius:10,border:"1.5px solid rgba(255,255,255,0.2)",background:"rgba(255,255,255,0.06)",color:"rgba(255,255,255,0.7)",fontSize:13,cursor:"pointer",display:"flex",alignItems:"center",gap:6,touchAction:"manipulation"},children:["⚙ Настройки"]})}),"Выбирай классы"].map(v=>D.jsx("span",{style:{background:"rgba(255,68,153,0.12)",border:"1px solid rgba(255,68,153,0.28)",borderRadius:20,padding:"4px 12px",fontSize:11,color:"rgba(255,255,255,0.55)"},children:v},v))})]}),_stOpen&&D.jsx("div",{style:{position:"fixed",inset:0,zIndex:9999,background:"rgba(0,0,0,0.82)",display:"flex",alignItems:"center",justifyContent:"center",padding:20},onClick:()=>_setStOpen(false),children:D.jsxs("div",{style:{background:"#1a0514",border:"1.5px solid rgba(255,68,153,0.4)",borderRadius:18,padding:24,maxWidth:400,width:"100%",maxHeight:"85vh",overflowY:"auto"},onClick:e=>e.stopPropagation(),children:[D.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:18},children:[D.jsx("div",{style:{color:"#fff",fontSize:18,fontWeight:"bold"},children:"⚙ Настройки"}),D.jsx("button",{onClick:()=>_setStOpen(false),style:{background:"none",border:"none",color:"rgba(255,255,255,0.5)",fontSize:20,cursor:"pointer",padding:"0 4px"},children:"✕"})]}),D.jsxs("div",{style:{display:"flex",gap:8,marginBottom:20},children:[D.jsx("button",{onClick:()=>_setStTab("ui"),style:{flex:1,padding:"8px",borderRadius:8,border:"none",fontWeight:"bold",fontSize:13,cursor:"pointer",background:_stTab==="ui"?"rgba(200,0,100,0.7)":"rgba(255,255,255,0.07)",color:_stTab==="ui"?"#fff":"rgba(255,255,255,0.45)"},children:"🎛 Интерфейс"}),D.jsx("button",{onClick:()=>_setStTab("game"),style:{flex:1,padding:"8px",borderRadius:8,border:"none",fontWeight:"bold",fontSize:13,cursor:"pointer",background:_stTab==="game"?"rgba(200,0,100,0.7)":"rgba(255,255,255,0.07)",color:_stTab==="game"?"#fff":"rgba(255,255,255,0.45)"},children:"🎮 Управление"})]}),_stTab==="ui"&&D.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:20},children:[D.jsxs("div",{children:[D.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:8},children:[D.jsx("span",{style:{color:"#c0d8f0",fontSize:14,fontWeight:"bold"},children:"Размер UI"}),D.jsx("span",{style:{color:"#4af",fontSize:14,fontWeight:"bold"},children:Math.round((_uiScV||1)*100)+"%"})]}),D.jsx("input",{type:"range",min:"0.4",max:"2.5",step:"0.05",value:_uiScV||1,onInput:function(e){const v=parseFloat(e.target.value);_sUiScV&&_sUiScV(v);localStorage.setItem("diep_uiScale",String(v));},style:{width:"100%",accentColor:"#ff4499",cursor:"pointer",height:32}}),D.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginTop:4},children:[D.jsx("span",{style:{color:"rgba(255,255,255,0.3)",fontSize:11},children:"40% — маленький"}),D.jsx("span",{style:{color:"rgba(255,255,255,0.3)",fontSize:11},children:"250% — большой"})]})]}),D.jsx("button",{onClick:()=>{const def=Math.max(0.4,Math.min(2.5,Math.min(window.innerWidth,window.innerHeight)/420));_sUiScV&&_sUiScV(def);localStorage.removeItem("diep_uiScale");},style:{padding:"9px",borderRadius:10,border:"1px solid rgba(255,255,255,0.15)",background:"rgba(255,255,255,0.05)",color:"rgba(255,255,255,0.5)",fontSize:13,cursor:"pointer",width:"100%"},children:"↺ Сбросить по умолчанию"})]}),_stTab==="game"&&D.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:12},children:[D.jsx("div",{style:{color:"rgba(255,255,255,0.4)",fontSize:13,textAlign:"center",padding:"20px 0"},children:"⌨ Управление"}),D.jsxs("div",{style:{color:"rgba(255,255,255,0.6)",fontSize:13,lineHeight:2},children:["WASD / Стрелки — движение",D.jsx("br",{}),"Мышь — прицел  |  ЛКМ — стрельба",D.jsx("br",{}),"📱 Левый джойстик — движение",D.jsx("br",{}),"📱 Правый джойстик — прицел + стрельба"]})]})]})}),null]})});}const J0=()=>window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768;function _ModeLbl({mode:_m,lbl:_l,uiScale:_mlSc}){if(!_l)return null;return D.jsx("div",{style:{position:"absolute",top:68,left:"50%",transform:"translateX(-50%) scale("+(_mlSc||1)+")",transformOrigin:"top center",background:"rgba(0,0,0,0.68)",borderRadius:10,padding:"6px 18px",color:"#fff",fontFamily:"Arial",fontSize:13,fontWeight:"bold",zIndex:160,pointerEvents:"none",whiteSpace:"nowrap",letterSpacing:0.5},children:_l});}function FsBtn(){return null;}
